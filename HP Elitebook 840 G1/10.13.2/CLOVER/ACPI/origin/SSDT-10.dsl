 ...
 *
 * Disassembly of SSDT-10.aml, Sat Dec 30 02:43:12 2017
 *
...
DefinitionBlock ("", "SSDT", 1, "HP", "AMDSGTBL", 0x00001000)
{
        ...
        Method (AFN3, 1, Serialized)
        {
            ...
            While (One)
            {
                ...
                Else
                {
                    ...
                    ElseIf (And (DISI, 0x01))
                    {
                        And (CDIS, Not (0x01), DISP)
                    }
                    Else
                    {
                        Store (0x01, DISP)
    ...
    Scope (\_SB.PCI0.RP05)
    {
        ...
        Device (PEGA)
        {
            ...
            OperationRegion (ACAP, PCI_Config, 0x00, 0xF0)
